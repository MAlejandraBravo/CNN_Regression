...
#preprocessing_function especial para Xception
...
checkpoint=callbacks.ModelCheckpoint("BestModelXception.hdf5",monitor='val_loss',save_best_only=True,mode='min')#Save al mejor modelo. 
...
## evalución de modelo 
bestModel = load_model("BestModelXception.hdf5")
