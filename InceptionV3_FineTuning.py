...
#preprocessing_function especial para InceptionV3
...
checkpoint=callbacks.ModelCheckpoint("BestModelInceptionV3.hdf5",monitor='val_loss',save_best_only=True,mode='min')#Save al mejor modelo. 
...
# compile model
model.compile(optimizer=opt, loss='mse', metrics=["mean_squared_error","mean_absolute_error"])# se define la función de perdida 
#fit model
